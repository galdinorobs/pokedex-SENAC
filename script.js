...
let fogo = document.querySelector('.folha')
...
function mouseEntrar() {
    ...
    //alterando a opacidade do aviso de 0 para 1
...
listaSelecaoPokemons.forEach(pokemon => {
    ...
    pokemon.addEventListener('click', () => {
        ...
        //remove a classe aberto deste pokemon para que as informações dele sjam ocultadas
